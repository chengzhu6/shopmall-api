...
public class User {
     ...
     * @mbggenerated
     */
    public User(Integer id, String username, String password, String email, String phone, String qusetion, String answer, Integer role, Date createTime, Date updateTime, String ip) {
        this.id = id;
     ...
     *
     * @param qusetion the value for t_user.qusetion
     *
     * @mbggenerated
     */
